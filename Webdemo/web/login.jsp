...
<div class="loginbody">
    ...
    <div class="loginbox loginbox2">
        ...
        <form action="login.do" method="post">
            <ul>
                <li><input name="username" type="text" class="loginuser" value="guojiaqi" onclick="JavaScript:this.value=''"/></li>
                <li><input name="userpwd" type="password" class="loginpwd" value="admin" onclick="JavaScript:this.value=''"/></li>
                <li class="yzm">
