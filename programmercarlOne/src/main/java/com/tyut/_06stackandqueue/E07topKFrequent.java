...
public class E07topKFrequent {
    ...
    public static void main(String[] args) {
        E07topKFrequent e07topKFrequent = new E07topKFrequent();
        e07topKFrequent.topKFrequent1(new int[]{1,1,1,2,2,3},2);
    }
    ...
    public int[] topKFrequent(int[] nums, int k) {
        ...
        // lambda 表达式设置优先级队列从大到小存储 o1 - o2 为从小到大，o2 - o1 反之 小顶堆
