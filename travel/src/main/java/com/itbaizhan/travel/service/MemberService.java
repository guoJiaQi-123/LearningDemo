...
import com.itbaizhan.travel.pojo.Result;
...
public class MemberService {
    ...
    public Result register(Member member){
        ...
        String text = "尊敬的客户，<br/>\n" +
                "<br/>\n" +
                "感谢您选择惠农旅游网作为您的旅行伙伴！我们非常荣幸能够为您提供优质的服务，让您能够享受到真正独特的农村旅游体验。<br/>\n" +
                "<br/>\n" +
                ...
                "<br/>\n" +
                "借此机会，再次感谢您选择惠农旅游网。我们将竭诚为您提供最优质的服务，让您的农村旅行成为难忘的回忆。<br/>\n" +
                "<br/>\n" +
                ...
                "<br/>\n" +
                "惠农旅游网注册成功， 完成账号认证。";
        mailUtils.sendMail(to,text,"惠农旅游网激活邮件");
        // 保存激活码，激活时比对
